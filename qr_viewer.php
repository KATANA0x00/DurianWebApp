...
<body>
    ...
    <?php
        ...
        $sql = "SELECT *,CURDATE() AS stamp, DATEDIFF(CURDATE(), bloom_date) AS diff FROM durianDB.durianID WHERE ID = '".$params['ID']."'";
    ...
    <div class="container">
        <ul class="list" style="align-items: center;">
            <li><img src="/asset/img/durian.png" style="max-width:300px;"></li>
            <?php if($null_check != 0) echo "<form action=\"update.php?ID=".$params['ID']."&path=qr_viewer\" method=\"post\">" ?>
            ...
            <li style="margin-top: 20px;"><label style="color: var(--primary);">วันที่แสกน</label></li>
            ...
            <li style="margin-top: 40px;display:flex;flex-direction: row;">
                <label class="display-text">อายุ&nbsp;</label>
                <label class="display-text" style="color: var(--primary);">
                <?php
                    if($row["diff"] == NULL){
                        echo "X" ;
                    }
                ...
                <label class="display-text">&nbsp;วัน</label>
            </li>
            <li>
                <?php
